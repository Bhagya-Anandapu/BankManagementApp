...
public class Transactions extends JFrame implements ActionListener {
    ...
    JButton deposit,withdrawl,transfer,fastcash,ministatement,pinchange,balanceenquiery,exit;
    String pinnumber;
    ...
    Transactions(String pin){
        ...
        transfer.setBounds(265,375,150,30);
        ...
        balanceenquiery.setBounds(350,485,150,30);
        balanceenquiery.addActionListener(this);
        image.add(balanceenquiery);
        
        exit=new JButton("Exit");
        exit.setBounds(368,522,150,30);
